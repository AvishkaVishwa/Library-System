...
export default function HomePage({ displayLogin }: HomePageProps): JSX.Element {
    return (
        <div>
            <div>
            ...
            <div>
                <section className="home">
                    <div className="home-text">
                        ...
                        <h1>
                            <img src="https://lib.cmb.ac.lk/wp-content/uploads/2016/09/logo-3.png"
                                 width="300"
                                 alt="University Logo" />
                            <br />
                            <br />
                ...
                <div className="img-btn-container">
                    <a href="kitchen.html" className="img-btn">
                        <img src="https://mblogthumb-phinf.pstatic.net/MjAyMzA2MjhfNzQg/MDAxNjg3OTU0MzMwMzQz.lmwUACSWNSp57Q8bsyw4whoilqisDLq4AMwlN8dJ410g.lJAmKXYq651zXeQfdbfORnRDv18erTZnCs1qNPtY8-Yg.PNG.sandhya/1687954284677.png?type=w800"
                             alt="books" />
                        <span className="img-text">BOOKS</span>
                    </a>
                    <a href="guidelines.html" className="img-btn">
                        <img src="https://png.pngtree.com/png-vector/20220925/ourmid/pngtree-a-man-explains-list-of-rule-guidelines-png-image_6212795.png"
                             alt="guidelines" />
                        <span className="img-text">Guidelines</span>
                    </a>
                    <a href="staff.html" className="img-btn">
                        <img src="https://img.freepik.com/premium-photo/librarian-cartoon-character-3d-animation-illustration-guide_1029473-45225.jpg?w=360"
                             alt="staff" />
                        <span className="img-text">Staff</span>
                    </a>
                    <a href="registration.html" className="img-btn">
                        <img src="https://cdn3d.iconscout.com/3d/premium/thumb/registration-confirmed-3d-icon-download-in-png-blend-fbx-gltf-file-formats--sign-up-approval-validation-account-creation-enrollment-successful-approved-stamp-pack-seo-web-icons-8662343.png?f=webp"
                             alt="registration" />
